...
public class HospitalTest {
    ...
    public void CreatePatients() {
        p1 = new OutPatient("P1", "Bengaluru", LocalDate.of(2021,06,21));
        p2 = new OutPatient("P2", "Mysuru", LocalDate.of(2021,06,21));
        p3 = new OutPatient("P3", "Kolar", LocalDate.of(2021,06,20));
        p4 = new OutPatient("P4", "Bengaluru", LocalDate.of(2021,06,19));
        p5 = new OutPatient("P5", "Mysuru", LocalDate.of(2021,06,20));
    ...
    public void Test002_Verify_Patient_Is_Local() {
        Patient p6 = new OutPatient("P6", "Bengaluru", LocalDate.of(2021,06,20));
    ...
    public void Test003_Verify_Patient_Is_Not_Local() {
        Patient p7 = new OutPatient("P7", "Mysuru", LocalDate.of(2021,06,20));
